...
```
curl https://get.ignite.com/username/domcosmos@latest! | sudo bash
```
`username/domcosmos` should match the `username` and `repo_name` of the Github repository to which the source code was pushed. Learn more about [the install process](https://github.com/allinbits/starport-installer).
